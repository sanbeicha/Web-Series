...
Request 对象代表了一次 fetch 请求中的请求体部分，你可以自定义`Request`对象: A `Request` instance represents the request piece of a fetch call. By passingfetch a `Request` you can make advanced and customized requests:
