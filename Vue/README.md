...
建议前置阅读[现代 Web 开发基础](https://github.com/wx-chevalier/Web-Series)、[现代 Web 工程化实践](https://github.com/wx-chevalier/Web-Series/)、 [现代 JavaScript 开发：语法基础与工程实践](https://url.wx-coder.cn/lrKga)等。另外可以比照阅读[React 与前端工程化实践](https://parg.co/bIn)  等。
